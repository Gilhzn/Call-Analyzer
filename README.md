...
מגבלות החינם נדיבות לשימוש אישי: ~2 שעות אודיו לשעה ו-2,000 תמלולים ביום; ניתוח — 30 בקשות לדקה. **קבצים גדולים ממגבלת ההעלאה (25MB) מטופלים אוטומטית**: ההקלטה מפוצלת לחלקים של 10 דקות, כל חלק מתומלל בנפרד, התמליל מאוחה עם חותמות זמן רציפות והכול מסוכם כניתוח אחד. אם ההאצה נכשלת מכל סיבה, האפליקציה חוזרת אוטומטית לעיבוד מקומי.
